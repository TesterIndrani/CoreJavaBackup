		...
		public static void main(String[] args)
{
		...
		s1 = new StringBuilder("Core Java");		
	...
	System.out.println("substring staring from index 5 to 8= "+s1.substring(5,9));//returns substring from start to end-1 i.e. 5 to 8
		...
		StringBuilder s2 = new StringBuilder("Hello How are you.");
		...
		StringBuilder s3 = new StringBuilder("Java Programming");
		...
		String s6 = new String(s5);	//initializing String object by passing StringBuilder object as argument
